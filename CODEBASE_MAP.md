...
| `billing_pricing_policies`, `billing_task_rates` | platform/billing | Versioned point-value/margin/risk policy and per-task base/freeze limits; seeded in migration `20260825_0006` with shadow mode as the safe default, `20260826_0007` adds the followed-article refresh rate, and `20260826_0008` sets it to 20 points |
