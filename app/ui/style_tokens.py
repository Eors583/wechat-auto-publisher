...
UI_STYLE_SPEC: dict[str, dict[str, StyleToken]] = {
    ...
    "布局": {
        ...
        "secondary-preview-max": StyleToken("650px", "审核页广告栏预览最大宽度"),
        "secondary-preview-thumb": StyleToken("72px", "审核页广告缩略图尺寸"),
        "secondary-preview-thumb-mobile": StyleToken("58px", "窄屏广告缩略图尺寸"),
